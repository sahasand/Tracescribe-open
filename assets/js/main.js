(function () {
  ...
  var JOURNEY = [
    ...
    { href: "projects/statistical-programming.html", phase: "Analyze", phaseNum: 6, title: "Statistical Programming Pipeline",
      narr: "HF-001's collected data is standardized into CDISC SDTM, derived into ADaM, and rolled up into the TLF tables for the CSR, traceable end to end and independently double-programmed.", showsSubjects: true },
