...
- `demos/` holds the live demos. Most are **bundled copies** of sibling projects' static
  artifacts (`demos/cdisc/`, `demos/monitoring.html`, `demos/biostats/`,
  `demos/cro/`), generated by `sync-demos.sh` from repos under `~/Documents/` (`ccs-cdisc-demo`,
  `ccs-monitoring`, `dashboard-biostats`, `cro-website`). **Do not hand-edit
...
header/footer/theme-toggle markup is duplicated across all pages, and the two non-CDISC detail
