...
# NOTE: demos/icf.html, demos/ectd.html, and demos/ectd-builder.html are hand-authored (in-repo
# recreations of features from large backend apps that are NOT bundled: TraceScribe2's ICF generation,
# CSR Publishing's eCTD packaging + interactive builder). This script never manages them.
